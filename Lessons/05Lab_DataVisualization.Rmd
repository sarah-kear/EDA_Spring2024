...
PeterPaul.chem.nutrients$mont_f <- factor(
  PeterPaul.chem.nutrients$month, levels=1:12,
  labels = month.abb)

#Try again: Plot how many Lake observations occur each month
ggplot(PeterPaul.chem.nutrients, aes(x = mont_f)) +
  geom_bar()
...
PeterPaul.chem.nutrients$day <- day(PeterPaul.chem.nutrients$sampledate)
