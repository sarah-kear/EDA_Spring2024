...
```{r DataExercise-1a}
high <- c(52,34,41,49,56,65,69,69,66,62)
low <-c(21,18,18,29,46,57,58,58,51,42)
temp_df <- data.frame(high,low)
```
...
high_cel <- celsius(temp_df$high)
print(high_cel)

low_cel <- celsius(temp_df$low)
print(low_cel)
```
...
```{r DataExercise-1c}
temp_df <- data.frame(high, high_cel, low, low_cel)
```
