...
# created to obtain a bunch of data withouth understanding how a URL works *FOR USGS*
...
#searh site number = river number
# period = days of data we want
# format = rdb = relational database = tab delineated file = easy to pull into r
...
#Set the URL
theUR1L <- 'https://waterdata.usgs.gov/nwis/uv?search_site_no=02085070&period=24&format=rdb'
#searh site number = river number
# period = days of data we want
# format = rdb = relational database = tab delineated file = easy to pull into r

#Get the data, which starts on line 30
gage_data1 <- read.table(theUR1L,skip = 29,header=TRUE,sep='\t',stringsAsFactors = T)
# sep = \t means tab
...
# this just shpws that the value of data is changing
```


## APIs
# way to interface with new commands
