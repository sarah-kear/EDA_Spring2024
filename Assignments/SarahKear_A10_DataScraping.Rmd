...
df_withdrawals <- data.frame("WaterSystem" = rep(WaterSystem),
                             ...
                             "Apr", "Aug", "Dec"),
                             "Year" = rep(2022,12),
                             "Max_Withdrawals_mgd" = as.numeric(MaxDayUse)) %>%
...
> Answer: Yes, between 2016 and 2021, there is a staeady increase in water usage. Between 2010 and 2016, there also seems to be a slight decrease in water usage as well. 
>
