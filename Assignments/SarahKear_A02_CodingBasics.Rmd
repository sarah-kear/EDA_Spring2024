...
```{r basics 1}
#1.
# I am using the sequence function to generate a sequence from 1 to 30 by 3. It's function name is sequence1.
...
#3. 
# created conditional statements for the R to determine if mean is greater than the median of sequence1. The mean is equal to the median.
mean > median 
mean < median
mean != median
mean == median
...
```{r basics 2}
#5.
name <- list(c("Sarah", "Gus", "Mary", "Preston"))
name
test <- list(c(100, 49, 82, 24))
test
passed <- list(c("True", "False", "True", "False"))
passed
...
passed_test <- function(x){
  ifelse(x>49, "TRUE", "FALSE")} #log_exp, if TRUE, if FALSE
...
meal <- recipe4(students$test_score); meal
#11.
