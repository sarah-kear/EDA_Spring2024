...
# used geom_freqpoly() to make graph. changed the bins from 30 to 20.
...
```{r, Frequency Polygon of Test Locations}
# THIS ONE DOES NOT WORK. GO TO OFFICE HOURS ABOUT THIS ONE. Should i add the train_continuous() function?

ggplot(Neonics) +
  geom_freqpoly(aes(x = Publication.Year), bins = 20) +
  geom_freqpoly(aes(x = Test.Location), color = "aquamarine3") 
```
...
# Writing code for three different date formats
today <- Sys.Date()
