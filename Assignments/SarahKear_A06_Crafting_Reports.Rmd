...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="2018 Ozone values by month", fig.align="left", out.width="87%"}
...
plot1 <- epa_data %>% 
  ...
  labs(
    ...
    x = "Month", 
    y = expression("Ozone Concentration" ~ (mu*g /m^3)))
print(plot1)
```

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="2019 Ozone values by month", fig.align="left", out.width="87%"}
plot2 <- epa_data %>% 
  filter(Year == 2019) %>% 
  ggplot(
    aes(
...
## Git Repository
[https://github.com/sarah-kear/EDA_Spring2024](https://github.com/sarah-kear/EDA_Spring2024)
