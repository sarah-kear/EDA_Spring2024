...
```{r, echo=FALSE}
library(knitr)
EPATable <- data.frame(Item.Name = c('Source', 
                         'Date', 
                         'Filename'),
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="2018 Ozone values by month", fig.align="center", out.width="85%"}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="2019 Ozone values by month", fig.align="center", out.width="85%"}
plot2 <- epa_data %>% 
  filter(Year == 2019) %>% 
  ggplot(
    aes(
