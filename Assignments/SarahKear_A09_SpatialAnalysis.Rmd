...
usgs.gage.locations <- read.csv(here("Data/Raw/NWIS_SiteInfo_NE_RAW.csv"), stringsAsFactors = TRUE) %>%
...
Gage_Loc.sf <- Gage_Loc %>% 
  st_as_sf(coords = c('dec_long_va','dec_lat_va'),
           crs=#NEED THIS NUMBER)

#11. Re-examine the column names
colnames(Gage_Loc.sf)
